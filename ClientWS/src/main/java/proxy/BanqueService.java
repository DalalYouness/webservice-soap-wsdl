...
public interface BanqueService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getCompteList", targetNamespace = "http://ws/", className = "proxy.GetCompteList")
    @ResponseWrapper(localName = "getCompteListResponse", targetNamespace = "http://ws/", className = "proxy.GetCompteListResponse")
    @Action(input = "http://ws/BanqueService/getCompteListRequest", output = "http://ws/BanqueService/getCompteListResponse")
