 ...
 * 
 */
@WebServiceClient(name = "Banque_Ws", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8787/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws/", "Banque_Ws");
